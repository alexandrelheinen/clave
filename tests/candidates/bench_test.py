...
def test_benchmark_reports_repetitions_and_spread() -> None:
    """AC-BENCH-04: a single unlucky sample must be visible."""
...
def test_benchmark_discards_warmup_iterations() -> None:
    """AC-BENCH-03: warm-up runs, and is not counted."""
    calls: list[int] = []
...
def test_benchmark_records_machine_and_threads() -> None:
    """AC-BENCH-06: a latency without its machine is not a measurement."""
...
def test_parameter_count_of_an_object_without_parameters_is_zero() -> None:
    """AC-BENCH-01 tolerates a candidate that is not a torch module."""
